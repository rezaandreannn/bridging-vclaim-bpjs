<x-guest-layout>
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('login.peserta') }}" id="login-form">
            ...
            <!-- Email Address -->
            <div>
                <x-label for="email" :value="__('Masukan No Kartu')" />

                <x-input id="email" class="" type="text" name="no_kartu" :value="old('no_kartu')" />
            </div>
            ...
            <div class="">
                ...
                {{-- <div class="mt-2 text-danger text-small" id="pin-error" style="display: none;">PIN salah, coba lagi.
                </div> --}}
            </div>
            ...
            <div class="d-flex justify-content-end mt-4">
                ...
                <a class="text-muted" href="{{ route('password.request') }}" style="margin-right: 15px; margin-top:
                15px;">
