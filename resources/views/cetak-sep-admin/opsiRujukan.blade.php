        ...
        <div class="row justify-content-center">
            <div class="card shadow-sm bg-white rounded">
                ...
                <div class="card-body">
                    ...
                    <center>
                        <div class="pt-2 pr-2">
                            <a href="{{ route('cetaksep.rujukan.sep')}}" class="btn btn-info btn-lg">Rujukan baru</a>
                        </div>
                    </center>
            ...
            <div class="card shadow-sm bg-white rounded ml-2">
                ...
                <div class="card-body">
                    ...
                    <center>
                        <div class="pt-2 pr-2">
                            <a href="{{ route('cetaksep.rencankontrol.sep')}}" class="btn btn-danger btn-lg">Pasien Kontrol</a>
                        </div>
                    </center>
