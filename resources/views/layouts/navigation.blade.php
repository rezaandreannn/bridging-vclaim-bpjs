<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            @endcan
            @can('cetak sep')
            <li class="{{Request::is('cetaksep') ? 'active' : ''}}"><a class="nav-link"
                    href="{{ route('cetaksep.verify')}}"><i class="fas fa-user"></i><span>Cetak SEP Petugas</span></a>
            </li>
            ...
            <li class="dropdown {{Request::is('monitoring*') ? 'active' : ''}}">
                ...
                <ul class="dropdown-menu">
                    <<<<<<< HEAD <li class="{{Request::is('monitoring/kunjungan*') ? 'active' : ''}}"><a
                            class="nav-link" href="{{ route('monitoring.kunjungan')}}">Kunjungan</a>
            </li>
            =======
