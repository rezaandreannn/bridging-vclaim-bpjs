...
<html lang="en">
  ...
  <body style="width: 80mm">
    <div class="justify-content-center">
      <div
        class="p-0 m-2 border-1 align-self-start d-flex justify-content-center mb-3"
        style="width: 100%"
      >
      ...
      <div style="width: 100%" class="mt-0 m-2">
        <div
          class="text-sm-start align-self-start d-flex justify-content-left"
          style="width: 100%"
        >
          <!-- kiri -->
      ...
      <div
        class="p-0 m-2 border-1 align-self-start d-flex justify-content-center mb-2"
        style="width: 100%"
      >
        <div class="fw-bold border-0 p-0" style="width: 20%">
          <div class="p-2"></div>
      ...
      <div
        class="p-0 m-2 border-1 align-self-start d-flex justify-content-center mb-1"
        style="width: 100%"
      >
        <div class="fw-bold border-0 p-0" style="width: 20%">
          <div class="p-2"></div>
